...
def plot_velocity(model, title, source=None, receiver=None, colorbar=True, cmap="jet"):
    """
...
def plot_shotrecord(rec, model, t0, tn, title, colorbar=True):
    """
...
def plot_image(data, title, vmin=None, vmax=None, colorbar=True, cmap="gray"):
    """
